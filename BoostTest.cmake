...
.. command:: boost_discover_tests
  ...
  `DISCOVERY_MODE mode``
    Provides control over when ``boost_discover_tests`` performs test discovery.
...
function(boost_discover_tests TARGET)
  ...
  foreach(param IN ITEMS REPORTER OUTPUT_DIR OUTPUT_PREFIX OUTPUT_SUFFIX DISCOVERY_MODE TEST_SPEC PROPERTIES DL_PATHS)
    if(_${param})
